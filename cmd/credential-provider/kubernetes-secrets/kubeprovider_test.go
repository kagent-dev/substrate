...
func TestParseURI(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			uri:  "ate-secret://google-access-token.kubernetes.io/ns1/vertex/credentials.json",
			want: SecretRef{Namespace: "ns1", Name: "vertex", Key: "credentials.json", Kind: KindGoogleAccessToken},
		},
		{
			name: "google access token without key",
			uri:  "ate-secret://google-access-token.kubernetes.io/ns1/vertex",
			want: SecretRef{Namespace: "ns1", Name: "vertex", Kind: KindGoogleAccessToken},
		},
		...
		{name: "unknown kubernetes.io subdomain", uri: "ate-secret://vault.kubernetes.io/ns1/example-api", wantErr: true},
