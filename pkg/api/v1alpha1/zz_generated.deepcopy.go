...
func (in *ActorTemplateSpec) DeepCopyInto(out *ActorTemplateSpec) {
	*out = *in
	...
	if in.CloudHypervisor != nil {
		in, out := &in.CloudHypervisor, &out.CloudHypervisor
		*out = new(CloudHypervisorConfig)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CloudHypervisorConfig) DeepCopyInto(out *CloudHypervisorConfig) {
	*out = *in
	if in.AMD64 != nil {
		in, out := &in.AMD64, &out.AMD64
		*out = new(CloudHypervisorPlatformConfig)
		**out = **in
	}
	if in.ARM64 != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CloudHypervisorConfig.
func (in *CloudHypervisorConfig) DeepCopy() *CloudHypervisorConfig {
	if in == nil {
		return nil
	}
	out := new(CloudHypervisorConfig)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CloudHypervisorPlatformConfig) DeepCopyInto(out *CloudHypervisorPlatformConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CloudHypervisorPlatformConfig.
func (in *CloudHypervisorPlatformConfig) DeepCopy() *CloudHypervisorPlatformConfig {
	if in == nil {
		return nil
	}
	out := new(CloudHypervisorPlatformConfig)
