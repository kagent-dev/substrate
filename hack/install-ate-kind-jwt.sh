...
apply_sandbox_configs() {
  log_step "apply_sandbox_configs"
  run_kubectl apply -f "${ROOT}/manifests/ate-install/sandboxconfig-validation.yaml"
  run_kubectl apply -f "${ROOT}/manifests/ate-install/sandboxconfig-gvisor.yaml"
}
