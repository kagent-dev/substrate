...
if [[ $# -gt 0 ]]; then
  case "$1" in
    -h|--help)
      ...
      echo "  KIND_ENABLE_PODCERT Enable Pod Certificate feature gates (default: true)."
...
echo "Creating kind configuration for cluster '${KIND_CLUSTER_NAME}' (ipFamily=${IP_FAMILY}, KIND_ENABLE_PODCERT=${KIND_ENABLE_PODCERT})..."
