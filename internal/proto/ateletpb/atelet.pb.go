...
type WorkloadSpec struct {
	...
	Volumes       []*ResolvedVolume      `protobuf:"bytes,3,rep,name=volumes,proto3" json:"volumes,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WorkloadSpec) GetVolumes() []*ResolvedVolume {
	if x != nil {
		return x.Volumes
	}
	return nil
...
// VolumeFile is a single file within a resolved volume root.
...
func (x *VolumeFile) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VolumeFile) ProtoMessage() {}

func (x *VolumeFile) ProtoReflect() protoreflect.Message {
	mi := &file_atelet_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VolumeFile.ProtoReflect.Descriptor instead.
func (*VolumeFile) Descriptor() ([]byte, []int) {
	return file_atelet_proto_rawDescGZIP(), []int{7}
}

func (x *VolumeFile) GetRelativePath() string {
	if x != nil {
...
func (x *VolumeFile) GetContent() []byte {
	if x != nil {
		return x.Content
	}
	return nil
...
func (x *VolumeFile) GetMode() uint32 {
	if x != nil {
		return x.Mode
	}
	return 0
...
// ResolvedVolume is a template volume after Kubernetes sources are resolved.
type ResolvedVolume struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Files         []*VolumeFile          `protobuf:"bytes,2,rep,name=files,proto3" json:"files,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ResolvedVolume) Reset() {
	*x = ResolvedVolume{}
...
func (x *ResolvedVolume) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResolvedVolume) ProtoMessage() {}

func (x *ResolvedVolume) ProtoReflect() protoreflect.Message {
	mi := &file_atelet_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResolvedVolume.ProtoReflect.Descriptor instead.
func (*ResolvedVolume) Descriptor() ([]byte, []int) {
	return file_atelet_proto_rawDescGZIP(), []int{8}
}

func (x *ResolvedVolume) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ResolvedVolume) GetFiles() []*VolumeFile {
	if x != nil {
		return x.Files
	}
	return nil
...
const file_atelet_proto_rawDesc = "" +
	...
	"\x0eauthentication\x18\x03 \x01(\v2\x1c.atelet.AuthenticationConfigR\x0eauthentication\"\x94\x01\n" +
	"\fWorkloadSpec\x121\n" +
	"\n" +
	...
	"pauseImage\x120\n" +
	"\avolumes\x18\x03 \x03(\v2\x16.atelet.ResolvedVolumeR\avolumes\"\xad\x01\n" +
	"\tContainer\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05image\x18\x02 \x01(\tR\x05image\x12\x18\n" +
	"\acommand\x18\x03 \x03(\tR\acommand\x12\"\n" +
	"\x03env\x18\x04 \x03(\v2\x10.atelet.EnvEntryR\x03env\x128\n" +
	"\rvolume_mounts\x18\x05 \x03(\v2\x13.atelet.VolumeMountR\fvolumeMounts\"_\n" +
	"\n" +
	"VolumeFile\x12#\n" +
	...
	"\x0eResolvedVolume\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12(\n" +
	"\x05files\x18\x02 \x03(\v2\x12.atelet.VolumeFileR\x05files\"x\n" +
	"\vVolumeMount\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1d\n" +
	"\n" +
	"mount_path\x18\x02 \x01(\tR\tmountPath\x12\x19\n" +
	"\bsub_path\x18\x03 \x01(\tR\asubPath\x12\x1b\n" +
	"\tread_only\x18\x04 \x01(\bR\breadOnly\"4\n" +
	"\bEnvEntry\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
...
var file_atelet_proto_goTypes = []any{
	...
	(*VolumeFile)(nil),              // 7: atelet.VolumeFile
	(*ResolvedVolume)(nil),          // 8: atelet.ResolvedVolume
	(*VolumeMount)(nil),             // 9: atelet.VolumeMount
	(*EnvEntry)(nil),                // 10: atelet.EnvEntry
	(*RunResponse)(nil),             // 11: atelet.RunResponse
...
var file_atelet_proto_depIdxs = []int32{
	...
	8,  // 7: atelet.WorkloadSpec.volumes:type_name -> atelet.ResolvedVolume
	10, // 8: atelet.Container.env:type_name -> atelet.EnvEntry
	9,  // 9: atelet.Container.volume_mounts:type_name -> atelet.VolumeMount
	7,  // 10: atelet.ResolvedVolume.files:type_name -> atelet.VolumeFile
	4,  // 11: atelet.CheckpointRequest.runsc:type_name -> atelet.RunscConfig
	5,  // 12: atelet.CheckpointRequest.spec:type_name -> atelet.WorkloadSpec
	4,  // 13: atelet.RestoreRequest.runsc:type_name -> atelet.RunscConfig
	5,  // 14: atelet.RestoreRequest.spec:type_name -> atelet.WorkloadSpec
	0,  // 15: atelet.AteomHerder.Run:input_type -> atelet.RunRequest
	...
	11, // 18: atelet.AteomHerder.Run:output_type -> atelet.RunResponse
